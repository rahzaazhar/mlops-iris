...
@app.command()
def evaluate(
    run_id: Annotated[str, typer.Option(help="name of the experiment for this training workload")],
    results_fp: Annotated[str, typer.Option(help="file path to store evaluation results")] = None,
):
